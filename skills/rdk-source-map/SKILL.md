...
| Use a vision/perception ROS node (detect/stereo/SLAM/calib) | `hobot_*` underscore + `mono*/stereo*/face_*/hand_*` → no dedicated Skill; use `rdk-docs-reference` to search `tros_doc` |
